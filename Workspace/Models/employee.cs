...
namespace Workspace.Models
{
    public class employee
    {
        ...
        [Required(ErrorMessage = "This field is required for employee's data")]
        [MinLength(1,ErrorMessage = "kindly choose the city of residence")]
       ...
       [Range(1,100,ErrorMessage ="kindly enter a valid age ")]
        ...
        [Required(ErrorMessage ="pleasse enter the employees monthly salary")]
        [Range(0,int.MaxValue,ErrorMessage="kindly enter the new exmployee's salary")]
